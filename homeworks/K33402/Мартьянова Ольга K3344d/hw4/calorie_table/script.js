...
async function getCardHtml(product) {
    ...
    if (user) {
        ...
        if (favorites && favorites.includes(product.name)) {
            button += `
            <button class="btn btn-custom remove-btn" onclick="removeFromFavorites('${product.name}')">
                <svg class="icon">
            ...
            button += `<button class="btn btn-custom add-btn" onclick="addToFavorites('${product.name}')" >
                    <svg class="icon">
                        <use xlink: href="../svg/sprite.svg#favoriteIcon"></use>
                    </svg>
                    Add to favorites
                    </button >`;
        }
