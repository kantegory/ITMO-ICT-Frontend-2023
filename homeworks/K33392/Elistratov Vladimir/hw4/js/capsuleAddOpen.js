...
class CapsuleC{
    ...
    async decapsulate(event){
        if(!localStorage.accessToken){
            ...
            modalBody.innerHTML = "Для просмотра содержимого капсулы, вам необходимо войти в свой профиль. Зарегестрироваться и войти на сайт можно на главной странице"
