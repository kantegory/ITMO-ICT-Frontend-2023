...
class UserProfileGenerator{
    ...
    _getMainInfoHtml(user){
        ...
        return `
            <div class="col-lg-4">
                <div class="card mb-4 change-border-lightgreen back-ground-modal">
                    <div class="card-body text-center ">
                        <img src="https://placekitten.com/528/560" alt="avatar"
                             class="rounded-circle img-fluid" style="width: 150px;">
                        <h5 class="my-3 main-text">${user['username']}</h5>
                        <p class="text-muted mb-1 main-text">${user['extraProfileInfo1']}</p>
                        <p class="text-muted mb-4 main-text">${user['extraProfileInfo2']}</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-8 ">
                <div class="card mb-4 change-border-lightgreen back-ground-modal">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-3">
                                <p class="mb-0 main-text">Full name</p>
                            </div>
                            <div class="col-sm-9">
                                <p class="text-muted mb-0 main-text">${user['fullUsername']}</p>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            <div class="col-sm-3">
                                <p class="mb-0 main-text">Email</p>
                            </div>
                            <div class="col-sm-9">
                                <p class="mb-0 main-text">${user['email']}</p>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            <div class="col-sm-3">
                                <p class="mb-0 main-text">Phone</p>
                            </div>
                            <div class="col-sm-9">
                                <p class="mb-0 main-text" >${user['phoneNumber']}</p>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            <div class="col-sm-3">
                                <p class="mb-0 main-text">Address</p>
                            </div>
                            <div class="col-sm-9">
                                <p class="mb-0 main-text">${user['address']}</p>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            <div class="col-sm-3">
                                <p class="mb-0 main-text">Number of capsules</p>
                            </div>
                            <div class="col-sm-9">
                                <p class="mb-0 main-text">${user['ownCapsulesList'].length}</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    _getProfileNavbarHtml(user){
        ...
        return `
        <a class="navbar-brand main-text" href="index.html">Time capsules</a>
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link active main-text" aria-current="page" href="index.html">Home</a>
                </li>
            </ul>
            <button class="navbar-toggler back-ground-modal" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNavbar" aria-controls="offcanvasNavbar" aria-label="Toggle navigation">
