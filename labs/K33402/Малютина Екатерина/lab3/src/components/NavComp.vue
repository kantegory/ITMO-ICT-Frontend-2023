...
import {exit} from "@/composable/exit.js";
import {search} from "@/composable/search.js";
...
<template>
  <nav class="navbar container-fluid navbar-expand-md navbar-dark bg-dark m-0">
    <a href="/" class="navbar-brand" onclick="router.push('/')">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" display="none">
        <symbol id="theme" viewBox="0 0 32 32" xml:space="preserve">
          ...
          <g id="SVGRepo_iconCarrier">
            ...
            <path class="st0"
                  d="M16,12.55C17.2,10.43,19.48,9,22.09,9c0.16,0,0.31,0.01,0.47,0.02c-1.67,0.88-2.8,2.63-2.8,4.64 c0,2.9,2.35,5.25,5.25,5.25c1.6,0,3.03-0.72,3.99-1.85C28.48,20.43,25.59,23,22.09,23c-2.61,0-4.89-1.43-6.09-3.55"></path> </g>
        </symbol>
      </svg>
