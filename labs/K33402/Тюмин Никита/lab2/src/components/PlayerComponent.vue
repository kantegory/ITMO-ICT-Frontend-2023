...
export default {
  ...
  methods: {
    ...mapActions({
      playNextSongInCurrentPlaylist: 'player/playNextSong',
      playPreviousSongInCurrentPlaylist: 'player/playPreviousSong',
    }),
    playPause() {
      if (!this.currentSong) {
        return
    ...
    playNext() {
      this.playNextSongInCurrentPlaylist()
    },
    playPrevious() {
      this.playPreviousSongInCurrentPlaylist()
    }
  },
